...
\begin{abstract}
Monoscopic imaging systems have drawbacks that can severely affect applications that use these solutions. These systems are mostly used in fields involving autonomous control of vehicles and remote control applications. The main issues associated with monoscopic imaging are a lack of depth perception and a narrow field of view. These deficiencies pose a serious problem in fields that use monoscopic imaging because depth perception is essential for being able to accurately control any system. Without depth perception, people and automonous systems must use vague spatial cues from two-dimensional images to attempt to control a system. Unmanned aerial vehicles are forced to fly at middle to high altitudes whether they're being controlled by a human or operating autonomously because monoscopic imaging systems cannot allow unmanned aerial vehicles to safely avoid obstacles that are present at lower altitudes. The limited field of view caused by monoscopic imaging prevents a low altitude unmanned aerial vehicle from see obstacles that still pose a threat to the vehicle's wings.

A solution for dealing with the shortcomings of monoscopic imaging systems is the introduction of another camera to the system. This would create a stereoscopic imaging system. Stereoscopic imaging directly addresses the major shortcomings of a monoscopic system. Similar to a human's eyes, a stereoscopic system provides depth perception. This creates a three-dimensional image for the user, whether it is a human controlling a system or a machine making autonomous decisions based on visual stimuli. A stereoscopic system also provides a much wider field of view than a monoscopic one can. The benefits of using a stereoscopic imaging system make it preferable over any monoscopic system.
\end{abstract}
